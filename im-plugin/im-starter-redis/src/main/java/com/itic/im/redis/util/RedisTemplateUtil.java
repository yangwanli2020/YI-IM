package com.itic.im.redis.util;
...
public class RedisTemplateUtil {
     ...
     * @return
     */
    public void put(String key, String vk, String vv) {
        redisTemplate.opsForHash().put(key, vk, vv);
    }
    ...
    public String getMapString(String key, String key2) {
        Object o = redisTemplate.opsForHash().get(key, key2);
...
//       redisTemplate.opsForList().leftPushAll(key,"w","x","y");
     ...
     * @param data
     */
    public void pub(String chaneel, String data) {
        redisTemplate.convertAndSend(chaneel, data);
    }
     ...
     * @return
     */
    public Object valueDeserialize(byte[] data) {
